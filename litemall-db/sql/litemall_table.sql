...
CREATE TABLE `litemall_brand` (
  ...
  `version` int(11) DEFAULT '0' COMMENT '乐观锁字段',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1046001 DEFAULT CHARSET=utf8 COMMENT='品牌商表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `parent_id` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=1036005 DEFAULT CHARSET=utf8 COMMENT='类目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_comment` (
  ...
  `content` varchar(1023) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '评论内容',
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=1181003 DEFAULT CHARSET=utf8 COMMENT='商品基本信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=874 DEFAULT CHARSET=utf8 COMMENT='商品参数表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_goods_specification` (
  ...
  PRIMARY KEY (`id`),
  KEY `goods_id` (`goods_id`)
) ENGINE=InnoDB AUTO_INCREMENT=260 DEFAULT CHARSET=utf8 COMMENT='商品规格表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_keyword` (
  ...
  `version` int(11) DEFAULT '0' COMMENT '乐观锁字段',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='关键字表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_product` (
  ...
  `version` int(11) DEFAULT '0' COMMENT '乐观锁字段',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=259 DEFAULT CHARSET=utf8 COMMENT='商品货品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_region` (
  ...
  KEY `agency_id` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=46183 DEFAULT CHARSET=utf8 COMMENT='行政区域表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_system` (
  ...
  `version` int(11) DEFAULT '0' COMMENT '乐观锁字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `litemall_topic` (
  ...
  PRIMARY KEY (`id`),
  KEY `topic_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=315 DEFAULT CHARSET=utf8 COMMENT='专题表';
/*!40101 SET character_set_client = @saved_cs_client */;
